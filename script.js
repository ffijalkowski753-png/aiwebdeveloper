...
function buildPrompt() {
  ...
  const summary = {
    status: "lead requires phone qualification before any demo is delivered",
    client: {
    ...
    callBrief: {
      openingLine: `Dzień dobry, widziałem brief ${data.company}. Mam już pomysł, jak strona może zbierać ${data.goal}.`,
      questionsToAsk: [
      ...
      priceLogic: "Brief darmowy. Demo strony dopiero po akceptacji zakresu i budżetu.",
      suggestedOffer: "One-page premium WordPress + Elementor, copywriting AI, podstawowe SEO, formularz kontaktowy."
    },
    demoPromptForAgent: {
      role: "Senior website designer building a paid client demo for WordPress and Elementor",
    ...
    databaseMapping: {
      ...
      demoStatus: "{{project.demo_locked_until_approval}}"
    }
  };
